	...
	function gotinc(responseText, params) {
        ...
        fw.move(switcher, onlydir, xto, yto, Array( function(){
            ...
            if(cs[9] == 1){
                ...
                var breite = 0;
                if(cs[15] == 1){
					tbcontent += "<?php draw_image("ki_nav_full.png", "", "cursor:pointer; border:0px; margin:0px 2px 0px 2px; padding-top:2px; display:inline;", "onclick=\\\"kib.startExplorer(\" + gallerynumber + \");\\\" onmouseover=\\\"this.style.padding = '0px 0px 2px 0px';\\\" onmouseout=\\\"this.style.padding = '2px 0px 0px 0px';\\\" title='".htmlentities(stripslashes($ki_nav_maxi), ENT_QUOTES, "UTF-8")."' id='maxim_size'"); ?>";
