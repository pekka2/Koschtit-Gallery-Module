...
function kiv_module(){
	...
	function preloadgallery(){
		...
		if(picsize[0] != kib.pics[cur_gallery][cur_load].x){
			...
			preloading[cur_load].src = "<?php echo str_replace('../','',$galleriesdir); ?>" + kib.dirs[cur_gallery] + "/" + kib.pics[cur_gallery][cur_load].file;
		}
	}
                ...
                if(y > (windowY-dim[1])*0.5 && y < (windowY+dim[1])*0.5){
                    if(!wowdiv.firstChild){
                        ...
                        if(picsize[0] != kib.pics[cur_gallery][cur_pic+1].x){
                            ...
                            picsrc = "<?php echo  str_replace('../','',$galleriesdir); ?>" + kib.dirs[cur_gallery] + "/" + kib.pics[cur_gallery][cur_pic+1].file;
                        }
